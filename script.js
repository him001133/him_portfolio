...
document.querySelectorAll('.portfolio-item, .stat-item, .about-text, .contact-item').forEach(el => {
...
// Instagram Embed Refresh (in case dynamic content is loaded)
...
// Refresh Instagram embeds after filtering
filterButtons.forEach(button => {
    button.addEventListener('click', () => {
